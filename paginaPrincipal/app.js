...
<div class="container-fluid">
    ...
    <a class="navbar-brand text-white mx-3 " href="/paginaPrincipal/index.html"> <h2>Rolling Flow</h2></a>
...
footerAdmin.innerHTML =
 `<footer >
    <div id="footer-contacto" class="footer_movies conteiner m-0 text-center py-2 row bg-dark">
        <aside class="publicidad_footer order-2 order-md-1 col-xl-4 col-12 mx-0 my-2">
            <a href="/public/src/error/error.html" target="_blank"><img
        ...
        <div class="footer_redes order-2 order-md-3 col-xl-4 col-12 mx-md-0 my-4">
            <a class="mx-auto" href="/public/src/error/error.html"><i
